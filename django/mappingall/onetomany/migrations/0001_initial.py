# Generated by Django 2.2.7 on 2022-02-02 16:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empref', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='adrrefs', to='onetomany.Emp')),
            ],
        ),
    ]
