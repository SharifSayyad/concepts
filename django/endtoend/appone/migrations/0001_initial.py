# Generated by Django 2.2.7 on 2022-07-11 16:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empref', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='adrref', to='appone.Emp')),
            ],
        ),
    ]
